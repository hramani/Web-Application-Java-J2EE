...
function doCompletion() {
    ...
    var url = "ajaxfunctionProf?action=complete&id=" + escape(completeField.value);
    req = initRequest();
...
function appendProduct(productname) {
    ...
    linkElement.setAttribute("href", "ajaxfunctionProf?action=lookup&productname=" + productname);
